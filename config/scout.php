...
return [
    ...
    */
    ...
    'meilisearch' => [
        ...
        /*
         * The listings index, keyed by the model so `scout:sync-index-settings`
         * resolves the same prefixed name Scout writes documents to.
         *
         * The settings themselves — and above all the ranking rules, which are
         * what implement the brief's exact/partial match tiers — live on
         * App\Modules\Search\Support\ProductIndex so the module's own tests
         * and the sync command cannot end up configuring different things.
         * The reasoning is in app/Modules/Search/README.md.
         */
        'index-settings' => [
            Product::class => ProductIndex::settings(),
        ],
        'model-settings' => [
            // User::class => [
            //     'embedding' => [
