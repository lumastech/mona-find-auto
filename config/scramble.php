...
return [
     ...
     */
    'export_path' => 'storage/api/openapi.json',
    ...
    'info' => [
        ...
        The MonaFindAuto JSON API. Every buyer and seller capability in the web
        application is mirrored here for the mobile app.

        Responses use a single envelope: `{"data": ...}` on success and
        `{"error": {"code": "...", "message": "..."}}` on failure. Monetary
        amounts are integers in ngwee (1 ZMW = 100 ngwee) and are never floats.

        Authenticate with a Sanctum bearer token.
        MARKDOWN,
    ],

    'ui' => [
        'title' => 'MonaFindAuto API',
    ],
