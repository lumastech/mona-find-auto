...
<template>
    ...
    >
        ...
        <!--
            The same bell as the storefront. A shop owner gets order, payout
            and review notifications; routing them to a different inbox per
            area would mean checking three.
        -->
